...
//                                            String partyName = resultSnapshot.getValue().toString();
                                            String partyName = resultSnapshot.getValue(String.class);
...
//                                            }
                                            if (partyName != null) {
                                                results.put(partyName, results.getOrDefault(partyName, 0) + 1);
                                            }
                                        }
...
//                                        startActivity(getIntent());
                                        Toast.makeText(getApplicationContext(), "Results Calculated", Toast.LENGTH_LONG).show();
                                        curElectionBtn.setVisibility(View.GONE);
                                        candidateSnapshot.child("isDone").getRef().setValue("true");
                                        finish();
                                        startActivity(getIntent());
